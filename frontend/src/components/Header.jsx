    ...
    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20">
      ...
      <div className="md:w-1/2 flex flex-col items-start justify-center py-10 gap-4 m-auto md:py-[10vw] md:mb-[-30px]">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
          <img src={assets.group_profiles} alt="Doctor profiles" className="w-28" />
          <p className="text-white text-sm">
            Simple browser application to book appointments with doctors. <br className="hidden sm:block"/>
