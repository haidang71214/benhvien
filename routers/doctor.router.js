...
import { createAppointment, createMedicalRecord, createNowAppoinment, createPrescription, deleteAppointment, doctorGetMedicalRecord, getMedicalRecordPatients, searchPatients, updateAppointment } from '../controllers/doctor.controller';
import { middlewareTokenAsyncKey } from '../config/jwt';
